...
telega_custom1 = false
telega_custom2 = false
telega_custom3 = false
telega_custom4 = false
mega_custom1 = false
mega_custom2 = false
mega_custom3 = false
mega_custom4 = false
...
function CAddonTemplateGameMode:InitGameMode()
    ...
    GameRules:GetGameModeEntity():SetModifyGoldFilter(Dynamic_Wrap( CAddonTemplateGameMode, "doublegoldi"), self)
	self:StartModifierCheckLoop('modifier_item_roshanq')
    self:StartModifierCheckLoop('modifier_item_telega')
    self:StartModifierCheckLoop('modifier_item_mega')
end
	...
	Timers:CreateTimer(30, function()
		for i=1, 4 do
            if tron_custom1 == true then
                if mega_custom1 == true then
                    local unit_t1 = CreateUnitByName('npc_dota_creep_goodguys_melee_upgraded_mega',tower1_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                    local unit_t2 = CreateUnitByName('npc_dota_creep_goodguys_melee_upgraded_mega',tower2_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                    unit_t1:SetInitialGoalEntity(tower1_custom1_1)
                    unit_t2:SetInitialGoalEntity(tower2_custom1_1)
                else 
                    local unit_t1 = CreateUnitByName('npc_dota_creep_goodguys_melee',tower1_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
            ...
            if tron_custom4 == true then
                if mega_custom4 == true then
                    local unit3_t1 = CreateUnitByName('npc_dota_creep_badguys_melee_upgraded_mega',tower1_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                    local unit3_t2 = CreateUnitByName('npc_dota_creep_badguys_melee_upgraded_mega',tower2_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                    unit3_t1:SetInitialGoalEntity(tower1_custom4_1)
                    unit3_t2:SetInitialGoalEntity(tower2_custom4_1)
                else 
                    local unit3_t1 = CreateUnitByName('npc_dota_creep_badguys_melee',tower1_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
            ...
            if tron_custom3 == true then
                if mega_custom3 == true then
                    local unit5_t1 = CreateUnitByName('npc_dota_creep_goodguys_melee_upgraded_mega',tower1_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                    local unit5_t2 = CreateUnitByName('npc_dota_creep_goodguys_melee_upgraded_mega',tower2_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                    unit5_t1:SetInitialGoalEntity(tower1_custom3_1)
                    unit5_t2:SetInitialGoalEntity(tower2_custom3_1)
                else 
                    local unit5_t1 = CreateUnitByName('npc_dota_creep_goodguys_melee',tower1_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
            ...
            if tron_custom2 == true then
                if mega_custom2 == true then
                    local unit7_t1 = CreateUnitByName('npc_dota_creep_badguys_melee_upgraded_mega',tower1_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                    local unit7_t2 = CreateUnitByName('npc_dota_creep_badguys_melee_upgraded_mega',tower2_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                    unit7_t1:SetInitialGoalEntity(tower1_custom2_1)
                    unit7_t2:SetInitialGoalEntity(tower2_custom2_1)
                else 
                    local unit7_t1 = CreateUnitByName('npc_dota_creep_badguys_melee',tower1_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
        ...
        if tron_custom1 == true then
            if mega_custom1 == true then
                local unit2_t1 = CreateUnitByName('npc_dota_creep_goodguys_ranged_upgraded_mega',tower1_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                local unit2_t2 = CreateUnitByName('npc_dota_creep_goodguys_ranged_upgraded_mega',tower2_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                unit2_t1:SetInitialGoalEntity(tower1_custom1_1)
                unit2_t2:SetInitialGoalEntity(tower2_custom1_1)
                if telega_custom1 == true then
                    local telega1_t1 = CreateUnitByName('npc_dota_goodguys_siege_upgraded_mega',tower1_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                    local telega1_t2 = CreateUnitByName('npc_dota_goodguys_siege_upgraded_mega',tower2_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                    telega1_t1:SetInitialGoalEntity(tower1_custom1_1)
                    telega1_t2:SetInitialGoalEntity(tower2_custom1_1)
                end
            else
                local unit2_t1 = CreateUnitByName('npc_dota_creep_goodguys_ranged',tower1_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                local unit2_t2 = CreateUnitByName('npc_dota_creep_goodguys_ranged',tower2_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                ...
                unit2_t2:SetInitialGoalEntity(tower2_custom1_1)
                if telega_custom1 == true then
                    local telega1_t1 = CreateUnitByName('npc_dota_goodguys_siege',tower1_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                    local telega1_t2 = CreateUnitByName('npc_dota_goodguys_siege',tower2_custom1_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_1)
                    telega1_t1:SetInitialGoalEntity(tower1_custom1_1)
                    telega1_t2:SetInitialGoalEntity(tower2_custom1_1)
                end
            end
        ...
        if tron_custom4 == true then
            if mega_custom4 == true then
                local unit4_t1 = CreateUnitByName('npc_dota_creep_badguys_ranged_upgraded_mega',tower1_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                local unit4_t2 = CreateUnitByName('npc_dota_creep_badguys_ranged_upgraded_mega',tower2_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                unit4_t1:SetInitialGoalEntity(tower1_custom4_1)
                unit4_t2:SetInitialGoalEntity(tower2_custom4_1)
                if telega_custom4 == true then
                    local telega4_t1 = CreateUnitByName('npc_dota_badguys_siege_upgraded_mega',tower1_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                    local telega4_t2 = CreateUnitByName('npc_dota_badguys_siege_upgraded_mega',tower2_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                    telega4_t1:SetInitialGoalEntity(tower1_custom4_1)
                    telega4_t2:SetInitialGoalEntity(tower2_custom4_1)
                end
            else
                local unit4_t1 = CreateUnitByName('npc_dota_creep_badguys_ranged',tower1_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                local unit4_t2 = CreateUnitByName('npc_dota_creep_badguys_ranged',tower2_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                ...
                unit4_t2:SetInitialGoalEntity(tower2_custom4_1)
                if telega_custom4 == true then
                    local telega4_t1 = CreateUnitByName('npc_dota_badguys_siege',tower1_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                    local telega4_t2 = CreateUnitByName('npc_dota_badguys_siege',tower2_custom4_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_4)
                    telega4_t1:SetInitialGoalEntity(tower1_custom4_1)
                    telega4_t2:SetInitialGoalEntity(tower2_custom4_1)
                end
            end
        ...
        if tron_custom3 == true then
            if mega_custom3 == true then
                local unit6_t1 = CreateUnitByName('npc_dota_creep_goodguys_ranged_upgraded_mega',tower1_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                local unit6_t2 = CreateUnitByName('npc_dota_creep_goodguys_ranged_upgraded_mega',tower2_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                unit6_t1:SetInitialGoalEntity(tower1_custom3_1)
                unit6_t2:SetInitialGoalEntity(tower2_custom3_1)
                if telega_custom3 == true then
                    local telega6_t1 = CreateUnitByName('npc_dota_goodguys_siege_upgraded_mega',tower1_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                    local telega6_t2 = CreateUnitByName('npc_dota_goodguys_siege_upgraded_mega',tower2_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                    telega6_t1:SetInitialGoalEntity(tower1_custom3_1)
                    telega6_t2:SetInitialGoalEntity(tower2_custom3_1)
                end
            else
                local unit6_t1 = CreateUnitByName('npc_dota_creep_goodguys_ranged',tower1_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                local unit6_t2 = CreateUnitByName('npc_dota_creep_goodguys_ranged',tower2_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                ...
                unit6_t2:SetInitialGoalEntity(tower2_custom3_1)
                if telega_custom3 == true then
                    local telega3_t1 = CreateUnitByName('npc_dota_goodguys_siege',tower1_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                    local telega3_t2 = CreateUnitByName('npc_dota_goodguys_siege',tower2_custom3_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_3)
                    telega3_t1:SetInitialGoalEntity(tower1_custom3_1)
                    telega3_t2:SetInitialGoalEntity(tower2_custom3_1)
                end
            end
        ...
        if tron_custom2 == true then
            if mega_custom2 == true then
                local unit8_t1 = CreateUnitByName('npc_dota_creep_badguys_ranged_upgraded_mega',tower1_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                local unit8_t2 = CreateUnitByName('npc_dota_creep_badguys_ranged_upgraded_mega',tower2_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                unit8_t1:SetInitialGoalEntity(tower1_custom2_1)
                unit8_t2:SetInitialGoalEntity(tower2_custom2_1)
                if telega_custom2 == true then
                    local telega8_t1 = CreateUnitByName('npc_dota_badguys_siege_upgraded_mega',tower1_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                    local telega8_t2 = CreateUnitByName('npc_dota_badguys_siege_upgraded_mega',tower2_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                    telega8_t1:SetInitialGoalEntity(tower1_custom2_1)
                    telega8_t2:SetInitialGoalEntity(tower2_custom2_1)
                end
            else
                local unit8_t1 = CreateUnitByName('npc_dota_creep_badguys_ranged',tower1_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                local unit8_t2 = CreateUnitByName('npc_dota_creep_badguys_ranged',tower2_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                ...
                unit8_t2:SetInitialGoalEntity(tower2_custom2_1)
                if telega_custom2 == true then
                    local telega2_t1 = CreateUnitByName('npc_dota_badguys_siege',tower1_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                    local telega2_t2 = CreateUnitByName('npc_dota_badguys_siege',tower2_custom2_1:GetAbsOrigin(),true,nil,nil,DOTA_TEAM_CUSTOM_2)
                    telega2_t1:SetInitialGoalEntity(tower1_custom2_1)
                    telega2_t2:SetInitialGoalEntity(tower2_custom2_1)
                end
            end
            ...
            if PlayerResource:IsValidPlayerID(player_id) then
                ...
                if hero and hero:IsAlive() then
                    if hero:HasModifier(modifier_name) then
                        ...
                        if modifier_name == 'modifier_item_roshanq' then
                        ...
                        elseif modifier_name == 'modifier_item_telega' then
                            if team == DOTA_TEAM_CUSTOM_1 then
                                telega_custom1 = true
                            elseif team == DOTA_TEAM_CUSTOM_2 then
                                telega_custom2 = true
                        ...
                        elseif modifier_name == 'modifier_item_mega' then
                            if team == DOTA_TEAM_CUSTOM_1 then
                                mega_custom1 = true
                            elseif team == DOTA_TEAM_CUSTOM_2 then
                                mega_custom2 = true
...
function CAddonTemplateGameMode:doublegoldi(doubleg)
    doubleg.gold = doubleg.gold * 2  
    return true  
end

ListenToGameEvent("entity_killed", function(event)
    local killedEntity = EntIndexToHScript(event.entindex_killed)
    if killedEntity and killedEntity:IsRealHero() then
        local playerID = killedEntity:GetPlayerOwnerID()
        if PlayerResource:IsValidPlayer(playerID) then
            local hero = PlayerResource:GetSelectedHeroEntity(playerID)
            if hero:IsAlive() == false then
                local a = hero:GetRespawnTime()
                hero:SetTimeUntilRespawn(a * 0.5)
            end
        end
    end
end,nil)
